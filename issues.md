...
我同时上传了"yssy-Tree_20260112172242.txt"该项目的目录树,来供你参考；
...
你可以先按照步骤列出来分析流程，我确认每一步骤后开始；请你认真分析我的项目,等你深度分析之后把项目代码和逻辑等永久保存到记忆; 之后我开始向你描述开发需求和要求;
...
4：我再次强调要保存记忆，把yssy.zip项目中的所有源码保存，不要丢失；每次对话先去检索源码
