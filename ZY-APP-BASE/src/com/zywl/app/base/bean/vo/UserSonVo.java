...
public class UserSonVo extends BaseBean{
	...
	private double todayCreateIncome;

	private double todayCreatAnima;

	public double getTodayCreateIncome() {
		return todayCreateIncome;
	}

	public void setTodayCreateIncome(double todayCreateIncome) {
		this.todayCreateIncome = todayCreateIncome;
	}

	public double getTodayCreatAnima() {
		return todayCreatAnima;
	}

	public void setTodayCreatAnima(double todayCreatAnima) {
		this.todayCreatAnima = todayCreatAnima;
	}
