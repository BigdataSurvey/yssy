...
@Service
public class PbxManagerService {
	...
	public void connectManager(){
		if(managerSocket == null){
			...
			shakeHandsDatas.put("gameId", 12);
			managerSocket = new ManagerSocket(TargetSocketType.pbx, -1, managerProperties.get("manager.ws.address"), shakeHandsDatas);
