...
public class PbxService extends BaseService {
    ...
    public Object jionRoom(PbxService adminSocketServer, Command lotteryCommand, JSONObject data) {
        checkNull(data);
    ...
    public Object leveRoom(PbxService adminSocketServer, Command lotteryCommand, JSONObject data) {
        String userId = data.getString("userId");
    ...
    public JSONObject attackBoss(PbxService adminSocketServer, Command lotteryCommand, JSONObject data) throws InterruptedException {
    ...
    public JSONObject getRecord(PbxService adminSocketServer, Command lotteryCommand, JSONObject data) {
        checkNull(data);
        checkNull(data.get("userId"));
