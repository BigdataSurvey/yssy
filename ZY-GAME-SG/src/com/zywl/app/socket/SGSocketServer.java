...
import com.zywl.app.service.SGService;
...
@ServerEndpoint(value = "/SGServer"
		+ SocketConstants.SOCKET_CONNECT_SHAKE_HANDS, configurator = HttpSessionConfigurator.class)
public class SGSocketServer extends BaseServerSocket {
	private static final Log logger = LogFactory.getLog(SGSocketServer.class);
	...
	public SGSocketServer() {
		...
		SGService = SpringUtil.getService(SGService.class);
