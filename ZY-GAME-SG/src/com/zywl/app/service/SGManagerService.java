...
public class SGManagerService {
	...
	public void connectManager(){
		if(managerSocket == null){
			...
			shakeHandsDatas.put("gameId", 8);
			managerSocket = new ManagerSocket(TargetSocketType.sg, -1, managerProperties.get("manager.ws.address"), shakeHandsDatas);
