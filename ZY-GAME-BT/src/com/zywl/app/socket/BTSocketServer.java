...
@ServerEndpoint(value = "/BTServer"
		+ SocketConstants.SOCKET_CONNECT_SHAKE_HANDS, configurator = HttpSessionConfigurator.class)
public class BTSocketServer extends BaseServerSocket {
	private static final Log logger = LogFactory.getLog(BTSocketServer.class);
