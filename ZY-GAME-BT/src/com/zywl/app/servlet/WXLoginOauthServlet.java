                ...
                try {
                    ...
                    if (os.equals("1")){
                        if (iosAccessToken != null && iosOpenId != null) {
                            ...
                            Response.doResponse(asyncContext, loginService.loginOrRegister(iosOpenId, clientIp, versionId, oldWsid, inviteCode, wxInfo, accessTokenVail, deviceId, os).toJSONString());
                            return;
                        }
                    }
                    if (code==null){
