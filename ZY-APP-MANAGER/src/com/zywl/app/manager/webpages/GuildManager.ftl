            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:;">公会管理</a> </li>
                    </ul>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group input-group-primary mb-3">
                                            <div class="input-group-prepend col-min-7-5">
                                                <span class="input-group-text">公会ID：</span>
                                            </div>
                                            <input type="number" class="form-control" placeholder="公会ID" name="guildId">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="input-group input-group-primary mb-3">
                                            <div class="input-group-prepend col-min-7-5">
                                                <span class="input-group-text">公会名称：</span>
                                            </div>
                                            <input type="text" class="form-control" placeholder="公会名称" name="guildName">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="input-group input-group-primary mb-3">
                                            <div class="input-group-prepend col-min-7-5">
                                                <span class="input-group-text">会长ID：</span>
                                            </div>
                                            <input type="number" class="form-control" placeholder="会长ID" name="userId">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="input-group input-group-primary mb-3">
