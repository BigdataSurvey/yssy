            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:;">公告管理</a> </li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
             <div class="modal-content">
                 <div class="modal-header no-bd">
                     <h5 class="modal-title">{{${menuId}.currentTpl._title}}<span class="text-danger">{{${menuId}.currentTpl.title}}</span></h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="input-group input-group-danger">
                                    ...
                                    <input type="text" class="form-control" placeholder="标题，最多200个字符" maxlength="200" name="title">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="input-group input-group-danger">
                                    ...
                                    <input type="text" class="form-control" placeholder="排序" name="index">
                                </div>
                            </div>
                            <div class="col-md-12">
