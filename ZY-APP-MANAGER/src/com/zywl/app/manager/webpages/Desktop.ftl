...
<head>
    ...
    <!-- select2 -->
    <link rel="stylesheet" href="https://cdn.bootcdn.net/ajax/libs/select2/4.0.8/css/select2.min.css" />
    <!-- cropper -->
    <link rel="stylesheet" href="https://cdn.bootcdn.net/ajax/libs/cropper/4.0.0/cropper.min.css" />
    <!-- froalaEditor -->
    <link rel="stylesheet" href="https://cdn.bootcdn.net/ajax/libs/font-awesome/4.4.0/css/font-awesome.min.css" />
    <link rel="stylesheet" href="https://cdn.bootcdn.net/ajax/libs/codemirror/5.25.0/codemirror.min.css" />
    <link href="${staticfile}/files/froala-editor-2-9-1/css/froala_editor.pkgd.min.css" rel="stylesheet" type="text/css" />
    <link href="${staticfile}/files/froala-editor-2-9-1/css/froala_style.min.css" rel="stylesheet" type="text/css" />
    <!-- ng-table -->
    <link rel="stylesheet" href="https://cdn.bootcdn.net/ajax/libs/ng-table/0.8.3/ng-table.min.css" />
    <!-- Style.css -->
...
<body data-ng-controller="desktopCtrl as dctrl">
    ...
    <!-- froala_editor -->
    <script src="${staticfile}/files/assets/js/codemirror.min.js"></script>
    <script src="${staticfile}/files/assets/js/xml.min.js"></script>
    <script src="${staticfile}/files/froala-editor-2-9-1/js/froala_editor.pkgd.min.js"></script>
    <script src="${staticfile}/files/froala-editor-2-9-1/js/languages/zh_cn.js"></script>
    <!-- Max-length js --> 
    ...
    <script src="${staticfile}/files/assets/js/zh-cn.js"></script>
    ...
    <script src="${staticfile}/files/assets/js/howler.core.min.js"></script>
    <!--echarts-->
    <script src="${staticfile}/files/echarts/echarts.min.js"></script>
    <!-- clipboard -->
    ...
    <!-- datepicker -->
    <link rel="stylesheet" href="https://cdn.bootcdn.net/ajax/libs/bootstrap-datepicker/1.6.4/css/bootstrap-datepicker.standalone.min.css" />
    <!-- DateTimePicker -->
    <script src="${staticfile}/files/assets/js/bootstrap-datepicker.min.js"></script>
    <script src="https://cdn.bootcdn.net/ajax/libs/bootstrap-datepicker/1.6.4/locales/bootstrap-datepicker.zh-CN.min.js"></script>
    <!--angularjs-->
...
<#--    <script src="https://cdn.bootcdn.net/ajax/libs/libs/angular.js/1.5.8/i18n/angular-locale_zh.js"></script>-->
    <!-- ng-table -->
    <script src="${staticfile}/files/assets/js/ng-table.min.js"></script>
    <script>
