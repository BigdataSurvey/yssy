...
if(!window.CtrlFn_${menuId}){
    window.CtrlFn_${menuId} = function($scope, $rootScope, $filter, $interval,$timeout, $compile, $templateCache, $stateParams, datatableUtil, alertUtil, amountUtil, storageService, websocketService, toastr){
        ...
        function initTable() {
            baseTable = datatableUtil.init('#${menuId}_baseTable', {
                ...
                columns: [
                    ...
                    {data: "lv", title: '等级', render: datatableUtil.renderNormal},
                    {data: "exp", title: '经验', render: datatableUtil.renderNormal},
                    {data: "nextLvExp", title: '下级经验', render: datatableUtil.renderNormal},
                    {data: "pl", title: '疲劳值', render: datatableUtil.renderNormal},
                    {data: "maxPl", title: '最大疲劳值', render: datatableUtil.renderNormal},
                    {data: "mp", title: '蓝量值', render: datatableUtil.renderNormal},
                    {data: "realm", title: '境界', render: datatableUtil.renderNormal},
                    {data: "skill", title: '技能', render: datatableUtil.renderNormal},
                    {data: "boss", title: 'BOSS', render: datatableUtil.renderNormal},
                    {data: "adCoin", title: '广告铜钱收益', render: datatableUtil.renderNormal},
                    {data: "buyCoin", title: '当前等级购买铜钱数量', render: datatableUtil.renderNormal},
                    {data: "needTp", title: '是否需要突破', render: datatableUtil.renderNormal},
                    {data: "stealEggList", title: '偷蛋列表', render: datatableUtil.renderNormal},
        ...
        function loadData(data, callback, settings){
            ...
            websocketService.request('021070', searchData, function(command){
                if(command.success){
