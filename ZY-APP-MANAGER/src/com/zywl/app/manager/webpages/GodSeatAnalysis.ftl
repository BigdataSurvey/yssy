            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:;">神座分析</a> </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="page-wrapper">
                ...
                <div class="page-body">
                    <div class="card">
                        ...
                        <div class="card-block" id="${menuId}_echart_1" style="width:100%;height:400px;">
