<script>
    ...
    <#include "PlatformStatementManager.js">
</script>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:;">平台报表</a> </li>
                    </ul>
                </div>
            </div>
        </div>
                 ...
                 <div class="modal-body">
                    <form role="form" autocomplete="off" id="${menuId}_formEdit_amount">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="text-danger d-none">操作类型1：</label>
                                    <div class="w-s">
