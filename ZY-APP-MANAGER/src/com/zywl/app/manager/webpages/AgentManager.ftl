            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:;">代理管理</a> </li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="input-group input-group-danger">
                                    ...
                                    <input type="{{${menuId}.currentTpl.$type == 'edit'? 'password': 'text'}}" class="form-control" placeholder="{{${menuId}.currentTpl._pwdTips}}" maxlength="20" name="password">
                                </div>
                            </div>
                            <div class="col-md-12">
