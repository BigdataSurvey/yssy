        ...
        function initTalbe() {
            baseTable = datatableUtil.init('#${menuId}_baseTable', {
                ...
                columns: [
                    ...
                    {data: "subBuyPass", title: '购买步步生财', render: datatableUtil.renderNormal},
                    {data: "subGameBetDts", title: 'DTS参与', render: datatableUtil.renderNormal},
                    {data: "addGameWinDts", title: 'DTS获得', render: datatableUtil.renderNormal},
                    {data: "subGift", title: '购买每日礼包', render: datatableUtil.renderNormal},
                    {data: "subVip", title: '购买VIP', render: datatableUtil.renderNormal},
                    {data:"subDzGame",title: '报名打坐',render: datatableUtil.renderNormal},
                    {data:"addDzGame",title: '领取打坐',render: datatableUtil.renderNormal},
                    {data: "subCq", title: '军机参与', render: datatableUtil.renderNormal},
                    {data: "addCq", title: '军机获得', render: datatableUtil.renderNormal},
                    {data: "subXhmj", title: '虚妄迷局参与', render: datatableUtil.renderNormal},
                    {data: "addXhmj", title: '虚妄迷局产出', render: datatableUtil.renderNormal},
                    {data: "subGameEscort", title: '护送游戏参与', render: datatableUtil.renderNormal},
                    {data: "addGameEscort", title: '护送游戏产出', render: datatableUtil.renderNormal},
                    {data: "addReceivePop", title: '人气宝箱产出', render: datatableUtil.renderNormal},
                    {data: "subSendGreetingCard", title: '赠送人气消耗', render: datatableUtil.renderNormal},
                    {data: "subMailFee", title: '飞贴手续费', render: datatableUtil.renderNormal},
                    {data: "subMine", title: '玉石矿产消耗', render: datatableUtil.renderNormal},
                    {data: "addReceiveAchievement", title: '领取成就金币', render: datatableUtil.renderNormal},
                    {data: "addFromItem", title: '道具产出金币', render: datatableUtil.renderNormal},
                    {data: "addDispatch", title: '悬赏任务产出金币', render: datatableUtil.renderNormal},
                    {data: "addWander", title: '云游天下产出', render: datatableUtil.renderNormal},
                    {data: "addDice", title: '骰子产出金币', render: datatableUtil.renderNormal},
                    {data: "subShop", title: '商店购买', render: datatableUtil.renderNormal},
                    {data: "addPetBuy", title: '战马商城产出', render: datatableUtil.renderNormal},
                    {data: "addFriendBuy", title: '友情商店产出', render: datatableUtil.renderNormal},
                    {data: "addPirze", title: '奖池瓜分获得', render: datatableUtil.renderNormal},
                    {data: "subAfk", title: '快速作战', render: datatableUtil.renderNormal},
                    {data: "addReceiveMail", title: '领取邮件', render: datatableUtil.renderNormal},
                    ...
                    {data: "addCashFail", title: '提现失败返还', render: datatableUtil.renderNormal},
                    {data: "addReceiveIncome", title: '领取收益', render: datatableUtil.renderNormal},
                    {data: "addInvite", title: '邀请活动', render: datatableUtil.renderNormal},
                    {data: "addFriendPlayGame", title: '好友试玩收益', render: datatableUtil.renderNormal},
                    {data: "addPlayGame", title: '试玩增加', render: datatableUtil.renderNormal},
                    {data: "addDailyTask", title: '每日任务增加', render: datatableUtil.renderNormal},
                    {data: "subJoinAncient", title: '副本扫荡', render: datatableUtil.renderNormal}
                    ],
