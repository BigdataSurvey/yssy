        ...
        function initTalbe() {
            baseTable = datatableUtil.init('#${menuId}_baseTable', {
                ...
                columns: [
                    ...
                    {data: "addRedGame", title: '鞭炮领取', render: datatableUtil.renderNormal},
                    {data: "subRedZd", title: '鞭炮炸弹', render: datatableUtil.renderNormal},
                    {data: "subPit", title: '开通矿洞', render: datatableUtil.renderNormal},
                    {data: "addPit", title: '矿洞退款', render: datatableUtil.renderNormal},
