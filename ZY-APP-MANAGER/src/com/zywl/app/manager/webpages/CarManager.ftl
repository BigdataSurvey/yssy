            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:;">座驾管理</a> </li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-danger">
                                    ...
                                    <input type="text" class="form-control" placeholder="Icon图标" name="icon">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group input-group-danger">
                                    ...
                                    <input type="text" class="form-control" placeholder="svg图标" name="svgaIcon">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group input-group-danger">
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-danger">
                                    <div class="input-group-prepend col-min-7-5">
                                        <span class="input-group-text">每日单价：</span>
                                    </div>
                                    <input type="text" class="form-control" placeholder="每日单价" name="price">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <div class="input-group-prepend col-min-7-5">
                                        <span class="input-group-text">周价格：</span>
                                    </div>
                                    <input type="text" class="form-control" placeholder="周价格" name="weekPrice">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <div class="input-group-prepend col-min-7-5">
                                        <span class="input-group-text">月价格：</span>
                                    </div>
                                    <input type="text" class="form-control" placeholder="月价格" name="monthPrice">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <div class="input-group-prepend col-min-7-5">
                                        <span class="input-group-text">年价格：</span>
                                    </div>
                                    <input type="text" class="form-control" placeholder="年价格" name="yearPrice">
                                </div>
                            </div>
                            <div class="col-md-12">
        ...
        <div class="modal-dialog modal-lg" role="document">
             <div class="modal-content">
                 ...
                 <div class="modal-body text-center">
                    <div id="${menuId}_svga" class="ml-auto mr-auto d-none" loops="0" clearsAfterStop="true" style="width:600px;height:500px;overflow: hidden;"></div>
