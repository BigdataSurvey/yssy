            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:;">直播间公告管理</a> </li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>公告内容：</label>
                                    <textarea rows="5" cols="5"  class="form-control" placeholder="公告内容，最多200个字符" maxlength="200" name="title"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
