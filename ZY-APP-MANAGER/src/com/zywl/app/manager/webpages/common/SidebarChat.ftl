        ...
        <div class="card card_main p-fixed users-main">
            <div class="user-box">
                <div class="chat-search-box">
                    <a class="back_friendlist"> <i class="fa fa-chevron-left"></i> </a>
                ...
                <div class="main-friend-list">
                    <div class="media userlist-box waves-effect waves-light" data-id="1"
                        ...
                        <a class="media-left" href="#!"> <img class="media-object img-radius img-radius"
                                src="${staticfile}/files/assets/images/avatar-3.jpg" alt="Generic placeholder image ">
                    ...
                    <div class="media userlist-box waves-effect waves-light" data-id="2"
                        ...
                        <a class="media-left" href="#!"> <img class="media-object img-radius"
                                src="${staticfile}/files/assets/images/avatar-2.jpg" alt="Generic placeholder image">
                            <div class="live-status bg-success"></div>
                        </a>
                        <div class="media-body">
                            <div class="f-13 chat-header">
                    ...
                    <div class="media userlist-box waves-effect waves-light" data-id="3"
                        ...
                        <a class="media-left" href="#!"> <img class="media-object img-radius"
                                src="${staticfile}/files/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                            <div class="live-status bg-success"></div>
                        </a>
                        <div class="media-body">
                            <div class="f-13 chat-header">
...
<div class="showChat_inner">
    <div class="media chat-inner-header">
        <a class="back_chatBox"> <i class="fa fa-chevron-left"></i> Josephin Doe </a>
    </div>
    <div class="media chat-messages">
        <a class="media-left photo-table" href="#!"> <img class="media-object img-radius img-radius m-t-5"
                src="${staticfile}/files/assets/images/avatar-3.jpg" alt="Generic placeholder image"> </a>
    ...
    <div class="media chat-messages">
        ...
        <div class="media-right photo-table">
            <a href="#!"> <img class="media-object img-radius img-radius m-t-5"
                    src="${staticfile}/files/assets/images/avatar-4.jpg" alt="Generic placeholder image"> </a>
        </div>
    </div>
    <div class="chat-reply-box">
        <div class="right-icon-control">
            ...
            <div class="form-icon ">
                <button class="btn btn-success btn-icon  waves-effect waves-light"> <i
