...
if(!window.CtrlFn_${menuId}){
    window.CtrlFn_${menuId} = function($scope, $rootScope, $filter, $interval,$timeout, $compile, $templateCache, datatableUtil, alertUtil, amountUtil, storageService, websocketService, toastr){
        ...
        function initTable() {
            baseTable = datatableUtil.init('#${menuId}_baseTable', {
                ...
                columns: [
                    ...
                    {data: "adminAccount", title: '管理员账号', render: datatableUtil.renderNormal},
                    {data: "adminName", title: '管理员昵称', render: datatableUtil.renderNormal},
                    {data: "action", title: '动作', render: datatableUtil.renderNormal},
                    {data: "content", title: '内容', render: datatableUtil.renderNormal},
        ...
        function loadData(data, callback, settings){
            ...
            websocketService.request('021140', searchData, function(command){
                if(command.success){
