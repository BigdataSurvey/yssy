...
<div class="pcoded-content" id="${menuId}_content" data-ng-controller="Controller-${menuId} as ${menuId}">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:;">主播管理</a> </li>
                    </ul>
                </div>
            </div>
        </div>
                             ...
                             <form role="form" autocomplete="off" id="${menuId}_search" class="mt-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group input-group-primary mb-3">
                                            <div class="input-group-prepend col-min-7-5">
                                                <span class="input-group-text">蜜桃号：</span>
                                            </div>
                                            <input type="number" class="form-control" placeholder="蜜桃号" name="userNo">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="input-group input-group-primary mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group input-group-primary mb-3">
                                            ...
                                            <div class="w-s">
                                                <select class="form-control input-full select3" name="sex" multiple="multiple">
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group input-group-primary mb-3">
                                            <div class="input-group-prepend col-min-7-5">
                                                <span class="input-group-text">主播状态：</span>
                                            </div>
                                            <div class="w-s">
                                                <select class="form-control input-full select3" name="playerStatus" multiple="multiple">
                                                </select>
                                            </div>
                                        </div>
                                    </div>
    ...
    <!-- 修改主播信息 -->
    <div class="modal fade" id="${menuId}_rowModal" role="dialog" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-lg" role="document">
             <div class="modal-content">
                 <div class="modal-header no-bd">
                     <h5 class="modal-title">修改主播信息：<span class="text-danger">{{${menuId}.currentTpl._title}}</span></h5>
                 ...
                 <div class="modal-body">
                    <form role="form" autocomplete="off" id="${menuId}_formEdit">
                        <div class="row">
                             <div class="col-12">
                                <h6 class="form-text text-danger ml-2 mb-3">红色框体为必填项<br>分成比例，0.1 ~ 1之间</h6>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <div class="w-s">
                                        <select class="form-control input-full select4" name="sex">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="留空则取默认值：{{${menuId}.defaultFeeTpl.DEFAULT_PLAYER_GIFT_FEE}}" name="playerGiftFee">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="留空则取默认值：{{${menuId}.defaultFeeTpl.DEFAULT_PLAYER_TICKET_FEE}}" name="playerTicketFee">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <div class="input-group-prepend col-min-7-5">
                                        <span class="input-group-text">金币房分成比例：</span>
                                    </div>
                                    <input type="text" class="form-control" placeholder="留空则取默认值：{{${menuId}.defaultFeeTpl.DEFAULT_PLAYER_CHARGE_FEE}}" name="playerChargeFee">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <div class="input-group-prepend col-min-7-5">
                                        <span class="input-group-text">开通守护分成比例：</span>
                                    </div>
                                    <input type="text" class="form-control" placeholder="留空则取默认值：{{${menuId}.defaultFeeTpl.DEFAULT_PLAYER_GUARD_FEE}}" name="playerGuardFee">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <div class="w-s">
                                        <select class="form-control input-full select4" name="playerStatus" id="${menuId}_form_palyerStatus">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea rows="5" cols="5"  class="form-control" id="${menuId}_form_palyerStatus_mark" placeholder="主播状态变更原因，最多100个字符" maxlength="100" name="playerStatusMark"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
    ...
    <div class="modal fade" id="${menuId}_mapModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-lg" role="document">
             <div class="modal-content">
                 <div class="modal-header no-bd">
                     <h5 class="modal-title">查看主播定位：<span class="text-danger">{{${menuId}.currentTpl._title}}</span></h5>
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span> </button>
                 </div>
                 <div class="modal-body">
    ...
    <!-- 统计开播时长 -->
    <div class="modal fade" id="${menuId}_timeModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-lg" role="document">
             <div class="modal-content">
                 <div class="modal-header no-bd">
                     <h5 class="modal-title">主播：<span class="text-danger">{{${menuId}.currentTpl._title}}</span></h5>
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span> </button>
                 </div>
                 <div class="modal-body">
                    <form role="form" autocomplete="off" id="${menuId}_formTime">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group input-group-primary mb-3">
                                    <div class="input-group-prepend col-min-7-5">
                                    ...
                                    <input type="text" class="form-control datepicker" id="${menuId}-start-time-player" maxDate="${menuId}-end-time-player" name="startDate" autocomplete="off" placeholder="开始日期">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group input-group-primary mb-3">
                                    ...
                                    <input type="text" class="form-control datepicker" id="${menuId}-end-time-player" minDate="${menuId}-start-time-player" name="endDate" autocomplete="off" placeholder="截止日期">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <p>开播时长：<span id="${menuId}_timeTotal">-</span></p>
                            </div>
                            <div class="col-md-12">
                                <div class="alert alert-danger border-danger" ng-if="${menuId}.currentTpl._errorMsg">{{${menuId}.currentTpl._errorMsg}}</div>
                            </div>
                 ...
                 <div class="modal-footer no-bd">
                    <button type="button" class="btn btn-info btn-search mr-2" ng-disabled="${menuId}.loading" ng-click="${menuId}.localWeek()"><span class="btn-label"> <i class="fas fa-calendar-check-o"></i> </span> 本周 </button>
                    <button type="button" class="btn btn-info btn-search mr-2" ng-disabled="${menuId}.loading" ng-click="${menuId}.localMonth()"><span class="btn-label"> <i class="fas fa-calendar"></i> </span> 本月 </button>
                    <button type="button" class="btn btn-primary btn-search mr-2" ng-disabled="${menuId}.loading" ng-click="${menuId}.timeData()"><span class="btn-label"> <i class="fas fa-search"></i> </span> 查询 </button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><span class="btn-label mr-1"> <i class="fas fa-times"></i> </span> 关闭</button>
                 </div>
             </div>
         </div>
