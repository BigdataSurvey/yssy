...
<#--                            </div>-->
    ...
    <div class="modal fade" id="${menuId}_rowModal_active" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header no-bd">
                    <h5 class="modal-title">修改用户积分：<span class="text-danger">{{${menuId}.currentTpl._title}}</span></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span> </button>
                </div>
                <div class="modal-body">
                    <form role="form" autocomplete="off" id="${menuId}_formEdit_active">
                        <div class="row">
                            <#--                             <div class="col-12">-->
                            <#--                                <h6 class="form-text text-danger ml-2 mb-3">红色框体为必填项</h6>-->
                            <#--                            </div>-->
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-danger">
                                    <div class="input-group-prepend col-min-7-5">
                                        <span class="input-group-text">输入活动编号</span>
                                    </div>
                                    <input type="text" class="form-control" placeholder="1/2/3" name="activeNo">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-danger">
                                    <div class="input-group-prepend col-min-7-5">
                                        <span class="input-group-text">输入积分</span>
                                    </div>
                                    <input type="text" class="form-control" placeholder="输入积分" name="score">
                                </div>
                            </div>
                ...
                <div class="modal-footer no-bd">
                    <button class="btn btn-success" type="button" ng-disabled="${menuId}.saving" ng-click="${menuId}.saveEditDataActive()"><span class="btn-label mr-1"> <i class="fa fa-check"></i> </span> 提交</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><span class="btn-label mr-1"> <i class="fas fa-times"></i> </span> 关闭</button>
                </div>
            </div>
        </div>
