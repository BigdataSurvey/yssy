            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:;">游戏管理</a> </li>
                        <li class="breadcrumb-item"><a href="javascript:;">邮件管理</a> </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="page-wrapper">
                ...
                <div class="page-body">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-left">
                                <ul class="nav nav-tabs md-tabs" role="tablist"> 
                                    <li class="nav-item">
                                        <a class="nav-link ml-3 mr-3 text-nowrap h6 header-tab-title" data-toggle="tab" role="tab" ng-class="{'active': ${menuId}.currentTab == 1}" ng-click="${menuId}.switchTab(1)"><i class="fa fa-user mr-2"></i> 邮件列表</a>
                                        <div class="slide"></div> 
                                    </li>
                                 </ul> 
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="input-group input-group-primary mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="用户ID" name="fromUserId">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="input-group input-group-primary mb-3">
                                            <div class="input-group-prepend col-min-7-5">
                                                <span class="input-group-text">接收ID：</span>
                                            </div>
                                            <input type="number" class="form-control" placeholder="用户ID" name="toUserId">
                                        </div>
                                    </div>
                        ...
                        <div class="card-block" ng-show="${menuId}.currentTab == 2">
