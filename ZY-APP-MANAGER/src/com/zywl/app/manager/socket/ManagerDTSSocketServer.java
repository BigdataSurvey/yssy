...
@ServerEndpoint(value = "/ManagerDTSServer" + SocketConstants.SOCKET_CONNECT_SHAKE_HANDS, configurator = HttpSessionConfigurator.class)
public class ManagerDTSSocketServer extends BaseServerSocket {
private static final Log logger = LogFactory.getLog(ManagerDTSSocketServer.class);
	...
	public ManagerDTSSocketServer() {
		super(TargetSocketType.battleRoyale, false, true);
