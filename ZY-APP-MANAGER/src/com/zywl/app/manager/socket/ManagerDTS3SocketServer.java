...
@ServerEndpoint(value = "/ManagerDTS3Server" + SocketConstants.SOCKET_CONNECT_SHAKE_HANDS, configurator = HttpSessionConfigurator.class)
public class ManagerDTS3SocketServer extends BaseServerSocket {
private static final Log logger = LogFactory.getLog(ManagerDTS3SocketServer.class);
	...
	public ManagerDTS3SocketServer() {
		super(TargetSocketType.battleRoyale2, false, true);
