...
@ServerEndpoint(value = "/ManagerNHServer" + SocketConstants.SOCKET_CONNECT_SHAKE_HANDS, configurator = HttpSessionConfigurator.class)
public class ManagerLhdSocketServer extends BaseServerSocket {
private static final Log logger = LogFactory.getLog(ManagerLhdSocketServer.class);
	...
	public ManagerLhdSocketServer() {
		super(TargetSocketType.nh, false, true);
