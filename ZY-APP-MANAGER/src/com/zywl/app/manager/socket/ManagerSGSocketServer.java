...
@ServerEndpoint(value = "/ManagerSGServer" + SocketConstants.SOCKET_CONNECT_SHAKE_HANDS, configurator = HttpSessionConfigurator.class)
public class ManagerSGSocketServer extends BaseServerSocket {
private static final Log logger = LogFactory.getLog(ManagerSGSocketServer.class);
	...
	public ManagerSGSocketServer() {
		super(TargetSocketType.sg, false, true);
