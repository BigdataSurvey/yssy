...
@ServerEndpoint(value = "/ManagerDTS2Server" + SocketConstants.SOCKET_CONNECT_SHAKE_HANDS, configurator = HttpSessionConfigurator.class)
public class ManagerDTS2SocketServer extends BaseServerSocket {
private static final Log logger = LogFactory.getLog(ManagerDTS2SocketServer.class);
	...
	public ManagerDTS2SocketServer() {
		super(TargetSocketType.dts2, false, true);
