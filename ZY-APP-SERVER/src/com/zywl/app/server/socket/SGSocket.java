...
@ClientEndpoint
public class SGSocket extends BaseClientSocket {
    private static final Log logger = LogFactory.getLog(SGSocket.class);
    ...
    public SGSocket(TargetSocketType socketType, int reconnect, String server, JSONObject shakeHandsDatas) {
    ...
    public void onConnect(Object data) {
        ...
        Push.registPush(new PushBean(PushCode.updateSgInfo), new PushListener() {
            public void onRegist(BaseSocket baseSocket, Object data) {

            }

            public void onReceive(BaseSocket baseSocket, Object data) {
                logger.info("收到算卦房间信息变更" + data);
                JSONObject obj = JSONObject.from(data);
                Push.push(PushCode.updateSgInfo, "8", obj);

            }
        }, this);
        Push.registPush(new PushBean(PushCode.updateSgStatus), new PushListener() {
            public void onRegist(BaseSocket baseSocket, Object data) {

            }

            public void onReceive(BaseSocket baseSocket, Object data) {
                logger.info("收到算卦房间状态变更" + data);
                JSONObject obj = JSONObject.from(data);
                ...
                for (Object id : userIds) {
                    ...
                    Push.push(PushCode.updateSgStatus, userId, result);
                }
            }
        }, this);
