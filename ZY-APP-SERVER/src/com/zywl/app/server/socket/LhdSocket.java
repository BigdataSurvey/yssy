...
@ClientEndpoint
public class LhdSocket extends BaseClientSocket {
    private static final Log logger = LogFactory.getLog(LhdSocket.class);
    ...
    public LhdSocket(TargetSocketType socketType, int reconnect, String server, JSONObject shakeHandsDatas) {
