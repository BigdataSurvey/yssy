...
public class OppsMerchantConfig {
    public static MerConfig getMerchantConfig() {
        ...
        merConfig.setProcutId(HFPayContext.PRODUCT_ID);
        merConfig.setRsaPrivateKey(HFPayContext.RSA_PRIVATE_KEY);
        merConfig.setRsaPublicKey(HFPayContext.RSA_PUBLIC_KEY);
