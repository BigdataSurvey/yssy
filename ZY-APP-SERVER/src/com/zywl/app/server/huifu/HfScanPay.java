...
public class HfScanPay extends BaseCommon {
    ...
    private static Map<String, Object> getExtendInfos(String notifyUrl) {
        ...
        // 交易有效期
        extendInfoMap.put("time_expire", DateUtil.getHfOrderExpireTime());
        // 禁用信用卡标记
    ...
    private static JSONObject getPayeeInfo() {
    ...
    private static JSONArray getGoodsDetail() {
        JSONObject dto = new JSONObject();
        // 商品的编号
    ...
    private static JSONArray getStoreInfo() {
        JSONObject dto = new JSONObject();
        // 门店id
        // dto.put("id", "");
        // 门店名称
    ...
    private static JSONArray getAcctInfosRucan() {
        JSONObject dto = new JSONObject();
        // 分账金额
    ...
    private static JSONObject getSceneInfo() {
        JSONObject dto = new JSONObject();
        // 门店信息
    ...
    private static JSONObject getExtendParams() {
        JSONObject dto = new JSONObject();
        // 卡类型
        dto.put("card_type", "");
        // 支付宝点餐场景类型
    ...
    private static JSONObject getDetail() {
        JSONObject dto = new JSONObject();
        // 单品列表
    ...
    private static JSONArray getGoodsDetailWxRucan() {
        JSONObject dto = new JSONObject();
        // 商品编码
        // dto.put("goods_id", "");
        // 商品名称
