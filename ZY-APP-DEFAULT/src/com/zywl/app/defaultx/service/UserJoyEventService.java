...
public class UserJoyEventService extends DaoService {
    ...
    public UserJoy findByEventAndReceiver(String eventId, Long receiverUserId) {
        Map<String, Object> cond = new HashMap<>();
        cond.put("eventId", eventId);
        cond.put("receiverUserId", receiverUserId);
        return (UserJoy) findOne("findByEventAndReceiver", cond);
    }
     ...
     */
    @Transactional
    public void insert(UserJoy event) {
